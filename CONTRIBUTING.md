...
1. 先搜索 [已有 Issues](https://github.com/AME-CoLtd/Zhong-Pay/issues)，确认未被报告
2. 使用 [Bug 报告模板](https://github.com/AME-CoLtd/Zhong-Pay/issues/new?template=bug_report.md) 提交

### 💡 提出功能建议

1. 先在 [Discussions](https://github.com/AME-CoLtd/Zhong-Pay/discussions) 讨论可行性
2. 使用 [功能建议模板](https://github.com/AME-CoLtd/Zhong-Pay/issues/new?template=feature_request.md) 提交
...
感谢你的贡献！如有任何问题，欢迎在 [Discussions](https://github.com/AME-CoLtd/Zhong-Pay/discussions) 交流。

**AME & Entertainment** · [GitHub](https://github.com/AME-CoLtd) · [官网](https://www.amemusic.cn)
