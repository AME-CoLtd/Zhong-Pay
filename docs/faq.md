...
> **维护**：[AME](https://github.com/AME-dev) · 如果你的问题不在列表中，请 [提交 Issue](https://github.com/AME-dev/zhong-pay/issues/new?template=question.md)
...
> 仍未解决？请 [提交 Issue](https://github.com/AME-dev/zhong-pay/issues/new?template=question.md) 并附上详细错误信息。
> 
> **AME** 会尽快回复！
