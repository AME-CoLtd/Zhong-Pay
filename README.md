...
[![GitHub Issues](https://img.shields.io/github/issues/AME-dev/zhong-pay?style=flat-square)](https://github.com/AME-dev/zhong-pay/issues)

[快速开始](#-快速开始) · [部署文档](#-部署方式) · [API 文档](docs/api.md) · [提交 Issue](https://github.com/AME-dev/zhong-pay/issues/new/choose) · [贡献代码](CONTRIBUTING.md)
...
```bash
# 1. 克隆仓库
git clone https://github.com/AME-dev/zhong-pay.git
cd zhong-pay
...
- 🐛 **Bug 报告** → [提交 Bug Issue](https://github.com/AME-dev/zhong-pay/issues/new?template=bug_report.yml)
- 💡 **功能建议** → [提交 Feature Request](https://github.com/AME-dev/zhong-pay/issues/new?template=feature_request.yml)
- 🔒 **安全漏洞** → [提交安全 Issue（Private）](https://github.com/AME-dev/zhong-pay/security/advisories/new)
- 💬 **使用讨论** → [GitHub Discussions](https://github.com/AME-dev/zhong-pay/discussions)
...
[![Contributors](https://contrib.rocks/image?repo=AME-dev/zhong-pay)](https://github.com/AME-dev/zhong-pay/graphs/contributors)
...
[官网](https://ame.dev) · [GitHub](https://github.com/AME-dev) · [问题反馈](https://github.com/AME-dev/zhong-pay/issues)
